...
export const webglConfig = {
	...
	airport_label: {
		...
		"icon-scale": [
			...
			["case", ["==", ["get", "size"], "s"], 0.5, ["==", ["get", "size"], "m"], 0.6, 0.7],
			0.5,
		],
		"icon-rotate-with-view": false,
	},
	controller: {
		"stroke-color": [
			...
			[
				"case",
				["==", ["get", "type"], "tracon"],
				["case", ["var", "theme"], [222, 89, 234, 1], [222, 89, 234, 1]],
				["case", ["var", "theme"], [126, 138, 161, 1], [77, 95, 131, 1]],
			],
		],
		"stroke-width": 1,
		"stroke-offset": 0,
		"fill-color": [
			...
			[
				"case",
				["==", ["get", "type"], "tracon"],
				["case", ["var", "theme"], [222, 89, 234, 0.1], [222, 89, 234, 0.1]],
				["case", ["var", "theme"], [126, 138, 161, 0.1], [77, 95, 131, 0.1]],
			],
		],
	},
};
